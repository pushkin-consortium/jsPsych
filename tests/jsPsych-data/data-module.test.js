...
describe('#addProperties', () => {
  test('should add data to all trials if called before experiment starts', () => {
    const timeline = [
      { type: 'html-keyboard-response', stimulus: 'hello' },
    ];
  ...
  test('should add data to all trials retroactively', () => {
...
describe('#addDataToLastTrial', () => {
  test('should add any data properties to the last trial', () => {
    jsPsych.data._fullreset();
    const timeline = [
      {
...
describe('#getLastTrialData', () => {
  test('should return a new DataCollection with only the last trial\'s data', () => {
    jsPsych.data._fullreset();
    const timeline = [
      { type: 'html-keyboard-response', stimulus: 'hello' },
...
describe('#getLastTimelineData', () => {
  test('should return a new DataCollection with only the last timeline\'s data', () => {
    jsPsych.data._fullreset();
    const timeline = [
      {
        timeline:
...
describe('#displayData', () => {
  test('should display in json format', () => {
    const timeline = [
      { type: 'html-keyboard-response', stimulus: 'hello' },
    ];
    jsPsych.init({ timeline });
  ...
  test('should display in csv format', () => {
    const timeline = [
      { type: 'html-keyboard-response', stimulus: 'hello' },
    ];
    jsPsych.init({ timeline });
